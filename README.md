...
> [!IMPORTANT]
> When using C3 to create this project, select "no" when it asks if you want to deploy. You need to follow this project's [setup steps](https://github.com/cloudflare/templates/tree/main/device-info#setup-steps) before deploying.
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/device-info
```

A live public deployment of this template is available at [https://device-info.templates.workers.dev](https://device-info.templates.workers.dev)
